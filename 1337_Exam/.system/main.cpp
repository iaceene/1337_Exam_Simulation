...
void exam::exam_prompt(void)
{
    ...
    while (1)
    {
        ...
        else if (input == "repo_git")
        {
            ...
            if (is_linux)
                std::system("xdg-open https://github.com/SegFault777/1337_Exam_Simulation.git");
            else
                std::system("open https://github.com/SegFault777/1337_Exam_Simulation.git");
        }
        ...
        else if (input == "gradenow" && vip)
        {
            ...
            std::cout << "           **Unknown command**     type " << LIME << "help" << RESET << " for more help || By : SegFault777 " << std::endl;
        // info();
    }
}
// jo je taime
