...
void exam::exam_help()
{
    ...
    std::cout << "'cheat' command By ==> SegFault777" << std::endl;
    if (true)
    {
...
void exam::info(void)
{
    ...
    std::cout << std::endl
              << "==================================================================" << std::endl;
    std::cout << "Use the \"" << LIME << "grademe" << RESET << "\" command to be graded, or \"" << LIME << "help" << RESET << "\" to get some help. \nBy ==> SegFault777" << std::endl;
    backup = 1;
}
...
void connexion(void)
{
    system("clear");
    std::cout << RESET;
    std::string examsystem = "examshell By : SegFault777";
    ...
    usleep(600000);
    system("clear");
    std::cout << BOLD << UNDERLINE << "ExamShell By : SegFault777" << RESET << std::endl
              << std::endl;
...
int exam::stud_or_swim(void)
{
    ...
    {
        system("clear");
        std::cout << WHITE << BOLD << "   42EXAM By SegFault777\n" << std::endl;
        if(vip)
            std::cout << "    You are a " << LIME << "VIP" << WHITE << BOLD << " user" << RESET << std::endl << std::endl;
        else
            std::cout << "     Made by " << LIME << "SegFault777" << RESET << std::endl
                  << std::endl
                  << std::endl;
...
void exam::settings_menu(void)
{
    ...
    while (input != "0")
    {
        ...
        std::cout << LIME << "3." << WHITE << BOLD << " Anonymise data sending to LOG (no data will be sent<3) : ";
        if (setting_an)
            std::cout << LIME << BOLD << " ON" << RESET << std::endl;
        else
            std::cout << RED << BOLD << " OFF" << RESET << std::endl;
